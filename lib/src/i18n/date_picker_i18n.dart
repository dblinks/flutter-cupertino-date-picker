...
class DatePickerI18n {
  ...
  static String getLocaleDone(DateTimePickerLocale locale) {
    _StringsI18n i18n = datePickerI18n[locale] ?? datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT] as _StringsI18n;
    return i18n.getDoneText() ?? datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT]!.getDoneText() as String;
  }

  /// Get cancel button text
  static String getLocaleCancel(DateTimePickerLocale locale) {
    _StringsI18n i18n = datePickerI18n[locale] ?? datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT] as _StringsI18n;
    return i18n.getCancelText() ?? datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT]!.getCancelText() as String;
  }
  ...
  static List<String> getLocaleMonths(DateTimePickerLocale locale) {
    ...
    return datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT]!.getMonths() as List<String>;
  }
  ...
  static List<String> getLocaleWeeks(DateTimePickerLocale locale, [bool isFull = true]) {
    ...
    if (isFull) {
      ...
      return datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT]!.getWeeksFull() as List<String>;
    }
    ...
    return datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT]!.getWeeksShort() as List<String>;
  }
}
